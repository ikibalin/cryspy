...
class ObservedDataMem(dict):
    ...
    def __init__(self, h=None, k=None, l=None, flip_ratio=None, 
                 ...
                 beam_polarization_up=None, beam_polarization_down=None,
                 extinction_mosaicity=None, extinction_radius=None,
                 name=None):
        super(ObservedDataMem, self).__init__()
        self._p_h = None
        self._p_k = None
        self._p_l = None
        ...
        self._p_beam_polarization_up = None
        self._p_beam_polarization_down = None
        
        self._p_extinction_mosaicity = None
        self._p_extinction_radius = None
        self._p_name = None

        self._refresh(h, k, l, flip_ratio, sflip_ratio, wave_length, field, 
                 orientation, file_dir, file_name, beam_polarization_up,
                 beam_polarization_down, extinction_mosaicity, 
                 extinction_radius, name)
 ...
 file_name: {:}""".format(self._p_file_dir, self._p_file_name)
    ...
    def _refresh(self, h, k, l, flip_ratio, sflip_ratio, wave_length, field, 
        ...
        if beam_polarization_up is not None:
            self._p_beam_polarization_up = beam_polarization_up
        if beam_polarization_down is not None:
            self._p_beam_polarization_down = beam_polarization_down
        if extinction_mosaicity is not None:
            self._p_extinction_mosaicity = extinction_mosaicity
        if extinction_radius is not None:
            self._p_extinction_radius = extinction_radius
        if name is not None:
            self._p_name = name
...
Parameters:
 ...
 beam_polarization_up is the polarization of the beam with spin up
 beam_polarization_down is the polarization of the beam with spin down
 extinction_mosaicity is extinction of the sample, mosaicity 
 extinction_radius is extinction of the sample, radius 
