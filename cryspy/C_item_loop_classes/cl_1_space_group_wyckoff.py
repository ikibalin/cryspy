...
class SpaceGroupWyckoff(ItemN):
    """SpaceGroupWyckoff contains information about Wyckoff positions of a space group.

Only one site can be given for each special position but the remainder can be generated by applying the symmetry operations stored in space_group_symop_operation_xyz.
    """
