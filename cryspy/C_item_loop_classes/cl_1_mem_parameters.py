...
- magnetization_density_to_den_file is the name of file with extension .den in which the reconstructed magnetisation density should be saved
    ...
    ATTR_OPTIONAL_NAMES = (
        "channel_col", "channel_ani", "channel_nucl", 
        "magnetization_plus", "magnetization_minus",
        "prior_density", "use_asymmetry", "gof_desired", 
        "spin_density_to_den_file", "magnetization_density_to_den_file"
        )
    ATTR_OPTIONAL_TYPES = (
        bool, bool, bool, 
        float, float, 
