...
class SpaceGroup(ItemN):
    """SpaceGroup defines the crystal space group.

Use it_number, name_hm_alt, name_hm_ref, name_hall, name_schoenflies to define the space group.
For non classicla choise of the system use IT_coordinate_system_code.

To defince magnetic space group instead this item use two loops: space_group_symop_magn_operation and space_group_symop_magn_centering (mcif).
    """
...
Use it_number, name_H-M_alt, name_H-M_ref, name_Hall, name_Schoenflies to define the space group.
For non classicla choise of the system use IT_coordinate_system_code.
