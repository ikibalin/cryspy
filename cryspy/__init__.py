...
from cryspy.A_functions_base.function_1_objects import (
    ...
    variable_name_to_string,
    change_variable_name,
    get_table_html_for_variables,
)
...
from cryspy.B_parent_classes.cl_2_loop import get_prefix_of_loop


from cryspy.D_functions_item_loop.function_1_section_from_density_point import (
...
from cryspy.procedure_rhochi.rhochi import (
...
def repr_function(function, flag_long: bool = False):
    ...
    if len_defaults_val == 0:
        ...
        s_in_2 = ", ".join(
            [f"{name:}=..." for name in varnames_in[-len_defaults_val:]]
        )
