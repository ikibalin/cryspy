...
def mempy_reconstruction_by_dictionary(dict_crystal, dict_mem_parameters, l_dict_diffrn, dict_in_out,
    ...
    if channel_ani:
        if "atom_para_label" in dict_crystal.keys():
    ...
    if channel_ani:
        ...
        if flag_moment_ordered:
            ...
            flag_ani, atom_label_auc_ani, atom_multiplicity_auc_ani, atom_distance_auc_ani, atom_symm_elems_auc_chi = \
    ...
    if channel_col and channel_ani:
        ...
        dict_in_out["point_multiplicity_channel_col"] = point_multiplicity_col
        ...
        if channel_ani:
            ...
            if flag_moment_ordered:
                ...
                mem_ani = calc_mem_chi(
                    index_hkl, unit_cell_parameters, h_ccs, full_symm_elems, symm_elem_auc_ani,
...
def mempy_cycle_density_susceptibility(dict_crystal, dict_mem_parameters, l_dict_diffrn, dict_in_out,
    ...
    for i_cycle in range(n_cycle):
        ...
        dict_in_out_susc = {} 
        mempy_susceptibility_refinement(dict_channel_ani, dict_crystal, dict_mem_parameters, l_dict_diffrn, dict_in_out_susc)
        print(70*" ")
