...
excl_phi_min=None, excl_phi_max is a list of excluded regions in phi
    ...
    def calc_profile(self, tth, phi, l_crystal, d_exp_prof_in={}):
        ...
        for calculated_data, d_cryst_in in zip(self._list_calculated_data, l_d_cryst_in):
            ...
            f_nucl_sq, f_m_p_sin_sq, f_m_p_cos_sq, cross_sin, d_cryst_cd_out = calculated_data.calc_for_iint(
            ...
            cond = ((setup.is_variable()) | (cell.is_variable()) | 
                   (isinstance(crystal._p_i_g, Variable)))
            if (("profile_3d" in l_key_cryst)&(not(cond))):
