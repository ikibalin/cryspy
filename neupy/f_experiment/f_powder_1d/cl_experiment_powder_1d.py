...
from neupy.f_experiment.f_powder_1d.cl_calculated_data_powder_1d import CalculatedDataPowder1D
from neupy.f_experiment.f_powder_1d.cl_observed_data_powder_1d import ObservedDataPowder1D
from neupy.f_experiment.f_powder_1d.cl_setup_powder_1d import SetupPowder1D
...
excl_tth_max is the list of excluded ttheta from up, down and sum (difference is taken into account), maximal
    ...
    def calc_profile(self, tth, l_crystal, d_exp_prof_in={}):
        ...
        l_d_cryst_out = []
        for calculated_data, d_cryst_in in zip(self._list_calculated_data, l_d_cryst_in):
            d_cryst_out = {}
            ind_cry = None
            ...
            d_cryst_out = {"h": h, "k": k, "l": l, "mult": mult}
            
            np_iint_u, np_iint_d, d_cryst_cd_out = calculated_data.calc_iint(h, k, l, 
            ...
            d_cryst_out.update({"tth_hkl": tth_hkl})
